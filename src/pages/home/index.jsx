...
import HomeSection from "@pages/home_section";
            ...
            <Container>
              ...
              <Box className={styles.home_img_contents}>
                <h5 className={styles.home_img_contents_h5}>
                  Are you an employer looking for applicants <br /> to fill your
                  job openings fast?
                </h5>
        ...
        <Container>
          <Box>
            ...
            <Box className={`${styles.social_img}`}>
              ...
              />
              <img src={IMAGES.Lingo} alt="img" className={`${styles.lingo}`} />
            </Box>
          ...
          <Box className={styles.stay_back_img}>
            <Box className={styles.stay_text_box}>
              ...
              <p>
                ...
                jobseeker, employer or vendor – you’ll get a lot of benefits of
                using the app. Get instant notifications and stay in touch with
                prospects.
              </p>
