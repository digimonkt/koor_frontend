...
export const getNotificationCardByType = (item, handleClose, role) => {
  switch (item.notificationType) {
    case NOTIFICATION_TYPE.advanceFilter:
      return <JobNotificationCard {...item} handleClose={() => handleClose()} role={role} />;
    case NOTIFICATION_TYPE.expiredJob:
      return <ExpiredJobCard {...item} handleClose={() => handleClose()} role={role} />;
    case NOTIFICATION_TYPE.applied:
      return <AppliedJobCard {...item} handleClose={() => handleClose()} role={role} />;
    case NOTIFICATION_TYPE.shortlisted:
      return <ShortlistedUserCard {...item} handleClose={() => handleClose()} role={role} />;
    case NOTIFICATION_TYPE.plannedInterviews:
      return <PlannedInterviewCard {...item} handleClose={() => handleClose()} role={role} />;
    case NOTIFICATION_TYPE.message:
      return <MessageNotificationCard {...item} handleClose={() => handleClose()} role={role} />;
    case NOTIFICATION_TYPE.rejected:
      return <RejectedCard {...item} handleClose={() => handleClose()} role={role} />;
    default:
      return <></>;
  }
};
